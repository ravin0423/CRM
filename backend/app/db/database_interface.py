...
class DealRepo(Protocol):
    async def list(self, **filters: Any) -> list[Any]: ...
    async def get(self, deal_id: int) -> Any | None: ...
    async def create(self, **data: Any) -> Any: ...
...
class KnowledgeRepo(Protocol):
    async def list(self, **filters: Any) -> list[Any]: ...
    async def get(self, article_id: int) -> Any | None: ...
    async def by_slug(self, slug: str) -> Any | None: ...
    async def create(self, **data: Any) -> Any: ...
    async def update(self, article_id: int, **data: Any) -> Any | None: ...
...
class WorkflowRepo(Protocol):
    async def list(self) -> list[Any]: ...
    async def get(self, workflow_id: int) -> Any | None: ...
    async def create(self, **data: Any) -> Any: ...
    async def update(self, workflow_id: int, **data: Any) -> Any | None: ...
...
class ChatRepo(Protocol):
    async def create(self, **data: Any) -> Any: ...
    async def get(self, conversation_id: int) -> Any | None: ...
    async def list(self, **filters: Any) -> list[Any]: ...
    async def append_message(self, conversation_id: int, message: dict[str, Any]) -> Any | None: ...
